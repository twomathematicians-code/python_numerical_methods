#!/usr/bin/env python3
"""
07_jacobi.py — Jacobi Iterative Method for Linear Systems

Solves Ax = b iteratively. Requires diagonal dominance for guaranteed
convergence.

x_i^{(k+1)} = (1 / a_{ii}) * (b_i - sum_{j!=i} a_{ij} * x_j^{(k)})

Run:      python src/07_jacobi.py
"""
...
def main():
    print_header("Jacobi Iterative Method — Linear System Solver")
